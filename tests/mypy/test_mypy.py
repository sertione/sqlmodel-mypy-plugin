...
cases: list[tuple[str, str]] = [
    ...
    ("mypy-plugin.ini", "sequence_name_collision.py"),
    ("mypy-plugin-strict.ini", "sequence_name_collision.py"),
    ("mypy-plugin.ini", "sqlmodel_reexported_sequence.py"),
    ("mypy-plugin-strict.ini", "sqlmodel_reexported_sequence.py"),
    ...
    ("mypy-plugin.ini", "aliased_joins.py"),
    ("mypy-plugin-strict.ini", "aliased_joins.py"),
    ...
    ("mypy-plugin-strict-typed-execute.ini", "session_execute_typed.py"),
    ...
    ("mypy-plugin.ini", "field_validation_alias.py"),
    ("mypy-plugin-strict.ini", "field_validation_alias.py"),
    ...
    ("mypy-plugin-strict.ini", "tuple_expression.py"),
]
